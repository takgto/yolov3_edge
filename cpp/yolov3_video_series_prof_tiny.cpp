...
Mat runYOLO(vart::Runner *runner, const Mat& frame) {
    ...
    */
    ...
    cout << "\nrunYOLO preprocessing time= " << 
        std::chrono::duration_cast<std::chrono::milliseconds>(runyolo_pre_endtime - runyolo_pre_starttime).count() 
        << " [mS]\n" << flush; 
    ...
    cout << "\nrunYOLO dpu time= " << 
        std::chrono::duration_cast<std::chrono::milliseconds>(runyolo_dpu_endtime - runyolo_dpu_starttime).count() 
        << " [mS]\n" << flush; 
    ...
    cout << "\nrunYOLO post time= " << 
        std::chrono::duration_cast<std::chrono::milliseconds>(runyolo_post_endtime - runyolo_post_starttime).count() 
        << " [mS]\n" << flush; 
...
int main(const int argc, const char** argv) {
	...
	index++;
        ...
        cout << "\nrunYOLO disp time= " << 
        std::chrono::duration_cast<std::chrono::milliseconds>(runyolo_disp_endtime - runyolo_disp_starttime).count() 
        << " [mS]\n" << flush; 
