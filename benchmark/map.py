...
parser.add.argument('--gt', type=str, default='mAP/ground-truth', help="path to the ground-truth directory.")
parser.add_argument('--dr', type=str, default='mAP/detection-results', help="path to the detection-results directory.")
...
GT_PATH = os.path.join(os.getcwd(), args.gt)
DR_PATH = os.path.join(os.getcwd(), args.dr)
